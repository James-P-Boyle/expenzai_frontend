...
export function Button({
    ...
    const baseClasses = 'w-full max-w-[450px] inline-flex font-sans items-center justify-center font-semibold rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer transition-all hover:scale-105'
